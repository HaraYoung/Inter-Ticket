    ...
    <div v-for="v in this.reviewList" :key="v.id">
      <div class="review-box" v-if="v.delete_state">
        <div class="review-desc mb-4">
          ...
          ></star-rating>
          <star-rating :star-size="30" :show-rating="false" :rating="v.rating" v-else></star-rating>
          <!-- 변경된 별점-->
        ...
        <div class="review-comment">
          ...
          <div class="commentBtn">
            <span v-if="v.edit_state == EditState ">
              <b-button class="ticketBtn m-2" @click="clickEdit(v.id)">수정</b-button>
              <b-button class="ticketBtn" @click="clickDelete(v.id)">삭제</b-button>
            </span>
            <span v-else class="btnRight">
              <b-button class="ticketBtn m-2" @click="clickEdit_2(v.id)">수정</b-button>
            </span>
          </div>
        </div>
        <!-- 리뷰 내용 -->
